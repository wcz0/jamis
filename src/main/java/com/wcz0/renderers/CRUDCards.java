...
public class CRUDCards extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public CRUDCards testid(Object value) {
		return (CRUDCards) this.set("testid", value);
	}
    ...
    */
	...
	/**
	    */
	public CRUDCards testIdBuilder(Object value) {
		return (CRUDCards) this.set("testIdBuilder", value);
	}
