...
public class QuarterRangeControl extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public QuarterRangeControl testIdBuilder(Object value) {
		return (QuarterRangeControl) this.set("testIdBuilder", value);
	}
    ...
    */
	public QuarterRangeControl autoFill(Object value) {
		return (QuarterRangeControl) this.set("autoFill", value);
	}
	
	/**
	    */
	public QuarterRangeControl initAutoFill(Object value) {
		return (QuarterRangeControl) this.set("initAutoFill", value);
	}
    ...
    */
	 ...
	 * 弹窗容器选择器
    */
	public QuarterRangeControl popOverContainerSelector(Object value) {
		return (QuarterRangeControl) this.set("popOverContainerSelector", value);
	}
