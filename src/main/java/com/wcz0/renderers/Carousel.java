...
public class Carousel extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public Carousel testid(Object value) {
		return (Carousel) this.set("testid", value);
	}
    ...
    */
	...
	/**
	    */
	public Carousel testIdBuilder(Object value) {
		return (Carousel) this.set("testIdBuilder", value);
	}
