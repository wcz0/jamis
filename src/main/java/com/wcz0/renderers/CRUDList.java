...
public class CRUDList extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public CRUDList testIdBuilder(Object value) {
		return (CRUDList) this.set("testIdBuilder", value);
	}
    ...
    */
	...
	/**
	    */
	public CRUDList testid(Object value) {
		return (CRUDList) this.set("testid", value);
	}
