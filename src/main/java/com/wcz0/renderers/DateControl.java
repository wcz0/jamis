...
public class DateControl extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public DateControl testIdBuilder(Object value) {
		return (DateControl) this.set("testIdBuilder", value);
	}
    ...
    */
	public DateControl autoFill(Object value) {
		return (DateControl) this.set("autoFill", value);
	}
    ...
    */
	 ...
	 * 弹窗容器选择器
    */
	public DateControl popOverContainerSelector(Object value) {
		return (DateControl) this.set("popOverContainerSelector", value);
	}
    ...
    */
	...
	/**
	    */
	public DateControl initAutoFill(Object value) {
		return (DateControl) this.set("initAutoFill", value);
	}
