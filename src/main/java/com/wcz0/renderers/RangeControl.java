...
public class RangeControl extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public RangeControl testIdBuilder(Object value) {
		return (RangeControl) this.set("testIdBuilder", value);
	}
	
	/**
	 * 自动填充，当选项被选择的时候，将选项中的其他值同步设置到表单内。
    */
	public RangeControl autoFill(Object value) {
		return (RangeControl) this.set("autoFill", value);
	}
    ...
    */
	...
	/**
	    */
	public RangeControl initAutoFill(Object value) {
		return (RangeControl) this.set("initAutoFill", value);
	}
