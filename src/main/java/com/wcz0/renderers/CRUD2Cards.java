...
public class CRUD2Cards extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public CRUD2Cards testid(Object value) {
		return (CRUD2Cards) this.set("testid", value);
	}
    ...
    */
	...
	/**
	    */
	public CRUD2Cards testIdBuilder(Object value) {
		return (CRUD2Cards) this.set("testIdBuilder", value);
	}
