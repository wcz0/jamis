...
public class CRUDTable extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public CRUDTable testIdBuilder(Object value) {
		return (CRUDTable) this.set("testIdBuilder", value);
	}
    ...
    */
	...
	/**
	    */
	public CRUDTable testid(Object value) {
		return (CRUDTable) this.set("testid", value);
	}
