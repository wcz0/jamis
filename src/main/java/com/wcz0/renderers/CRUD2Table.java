...
public class CRUD2Table extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public CRUD2Table testIdBuilder(Object value) {
		return (CRUD2Table) this.set("testIdBuilder", value);
	}
    ...
    */
	...
	/**
	    */
	public CRUD2Table testid(Object value) {
		return (CRUD2Table) this.set("testid", value);
	}
