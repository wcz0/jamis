...
public class Operation extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public Operation testIdBuilder(Object value) {
		return (Operation) this.set("testIdBuilder", value);
	}
	
	/**
	    */
	public Operation testid(Object value) {
		return (Operation) this.set("testid", value);
	}
