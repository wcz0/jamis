...
public class SwitchContainer extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public SwitchContainer testid(Object value) {
		return (SwitchContainer) this.set("testid", value);
	}
    ...
    */
	...
	/**
	    */
	public SwitchContainer testIdBuilder(Object value) {
		return (SwitchContainer) this.set("testIdBuilder", value);
	}
