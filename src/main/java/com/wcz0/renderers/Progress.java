...
public class Progress extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public Progress testIdBuilder(Object value) {
		return (Progress) this.set("testIdBuilder", value);
	}
    ...
    */
	...
	/**
	    */
	public Progress testid(Object value) {
		return (Progress) this.set("testid", value);
	}
