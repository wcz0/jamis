...
public class Portlet extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public Portlet testid(Object value) {
		return (Portlet) this.set("testid", value);
	}
    ...
    */
	...
	/**
	    */
	public Portlet testIdBuilder(Object value) {
		return (Portlet) this.set("testIdBuilder", value);
	}
	}