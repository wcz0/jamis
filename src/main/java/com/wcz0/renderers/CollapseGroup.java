...
public class CollapseGroup extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public CollapseGroup testid(Object value) {
		return (CollapseGroup) this.set("testid", value);
	}
    ...
    */
	...
	/**
	    */
	public CollapseGroup testIdBuilder(Object value) {
		return (CollapseGroup) this.set("testIdBuilder", value);
	}
