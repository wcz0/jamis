...
public class Wizard extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public Wizard testid(Object value) {
		return (Wizard) this.set("testid", value);
	}
    ...
    */
	...
	/**
	    */
	public Wizard testIdBuilder(Object value) {
		return (Wizard) this.set("testIdBuilder", value);
	}
