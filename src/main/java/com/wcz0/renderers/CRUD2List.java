...
public class CRUD2List extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public CRUD2List testIdBuilder(Object value) {
		return (CRUD2List) this.set("testIdBuilder", value);
	}
    ...
    */
	...
	/**
	    */
	public CRUD2List testid(Object value) {
		return (CRUD2List) this.set("testid", value);
	}
