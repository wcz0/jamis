...
public class Status extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public Status testIdBuilder(Object value) {
		return (Status) this.set("testIdBuilder", value);
	}
    ...
    */
	...
	/**
	    */
	public Status testid(Object value) {
		return (Status) this.set("testid", value);
	}
