...
public class DrawerAction extends BaseRenderer {
    ...
    */
	 ...
	 * 数据映射
    */
	public DrawerAction data(Object value) {
		return (DrawerAction) this.set("data", value);
	}
    ...
    */
	...
	/**
	    */
	public DrawerAction testIdBuilder(Object value) {
		return (DrawerAction) this.set("testIdBuilder", value);
	}
