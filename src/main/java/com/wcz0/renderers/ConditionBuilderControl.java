...
public class ConditionBuilderControl extends BaseRenderer {
    ...
    */
	public ConditionBuilderControl autoFill(Object value) {
		return (ConditionBuilderControl) this.set("autoFill", value);
	}
    ...
    */
	...
	/**
	    */
	public ConditionBuilderControl initAutoFill(Object value) {
		return (ConditionBuilderControl) this.set("initAutoFill", value);
	}
    ...
    */
	...
	/**
	    */
	public ConditionBuilderControl testIdBuilder(Object value) {
		return (ConditionBuilderControl) this.set("testIdBuilder", value);
	}
    ...
    */
	 ...
	 * if 里面公式编辑器配置
    */
	public ConditionBuilderControl formulaForIf(Object value) {
		return (ConditionBuilderControl) this.set("formulaForIf", value);
	}
