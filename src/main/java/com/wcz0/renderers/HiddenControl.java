...
public class HiddenControl extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public HiddenControl testIdBuilder(Object value) {
		return (HiddenControl) this.set("testIdBuilder", value);
	}
    ...
    */
	public HiddenControl autoFill(Object value) {
		return (HiddenControl) this.set("autoFill", value);
	}
    ...
    */
	...
	/**
	    */
	public HiddenControl initAutoFill(Object value) {
		return (HiddenControl) this.set("initAutoFill", value);
	}
