...
public class ButtonToolbar extends BaseRenderer {
    ...
    */
	...
	/**
	    */
	public ButtonToolbar testIdBuilder(Object value) {
		return (ButtonToolbar) this.set("testIdBuilder", value);
	}
    ...
    */
	...
	/**
	    */
	public ButtonToolbar testid(Object value) {
		return (ButtonToolbar) this.set("testid", value);
	}
