...
public class MonthControl extends BaseRenderer {
	...
	/**
	    */
	public MonthControl testIdBuilder(Object value) {
		return (MonthControl) this.set("testIdBuilder", value);
	}
    ...
    */
	...
	/**
	    */
	public MonthControl initAutoFill(Object value) {
		return (MonthControl) this.set("initAutoFill", value);
	}
    ...
    */
	public MonthControl autoFill(Object value) {
		return (MonthControl) this.set("autoFill", value);
	}
