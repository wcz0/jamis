...
public class Spinner extends BaseRenderer {
	...
	/**
	    */
	public Spinner testid(Object value) {
		return (Spinner) this.set("testid", value);
	}
    ...
    */
	...
	/**
	    */
	public Spinner testIdBuilder(Object value) {
		return (Spinner) this.set("testIdBuilder", value);
	}
